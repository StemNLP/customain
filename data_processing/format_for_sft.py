...
Usage:
    ...
    uv run python data_processing/format_for_sft.py --input data/custom.jsonl --test-ratio 0.15
"""
...
def main():
    ...
    lines = args.input.read_text(encoding="utf-8").strip().splitlines()
    ...
    split_idx = max(1, int(len(formatted) * args.test_ratio))
