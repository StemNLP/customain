...
def main():
    ...
    parser.add_argument("--input", type=Path, default=Path("data/_intermediate/reply_pairs_raw.jsonl"))
    parser.add_argument("--output", type=Path, default=Path("data/_intermediate/reply_pairs_clean.jsonl"))
